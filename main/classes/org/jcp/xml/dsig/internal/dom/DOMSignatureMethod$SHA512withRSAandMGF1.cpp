...
$MethodInfo _DOMSignatureMethod$SHA512withRSAandMGF1_MethodInfo_[] = {
	{"<init>", "(Ljava/security/spec/AlgorithmParameterSpec;)V", nullptr, 0, $method(static_cast<void(DOMSignatureMethod$SHA512withRSAandMGF1::*)($AlgorithmParameterSpec*)>(&DOMSignatureMethod$SHA512withRSAandMGF1::init$)), "java.security.InvalidAlgorithmParameterException"},
	{"<init>", "(Lorg/w3c/dom/Element;)V", nullptr, 0, $method(static_cast<void(DOMSignatureMethod$SHA512withRSAandMGF1::*)($Element*)>(&DOMSignatureMethod$SHA512withRSAandMGF1::init$)), "javax.xml.crypto.MarshalException"},
