...
$MethodInfo _SignatureBaseRSA$SignatureRSASHA512MGF1_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(SignatureBaseRSA$SignatureRSASHA512MGF1::*)()>(&SignatureBaseRSA$SignatureRSASHA512MGF1::init$)), "com.sun.org.apache.xml.internal.security.signature.XMLSignatureException"},
	{"<init>", "(Ljava/security/Provider;)V", nullptr, $PUBLIC, $method(static_cast<void(SignatureBaseRSA$SignatureRSASHA512MGF1::*)($Provider*)>(&SignatureBaseRSA$SignatureRSASHA512MGF1::init$)), "com.sun.org.apache.xml.internal.security.signature.XMLSignatureException"},
...
void SignatureBaseRSA$SignatureRSASHA512MGF1::init$($Provider* provider) {
	$SignatureBaseRSA::init$(provider);
}

$String* SignatureBaseRSA$SignatureRSASHA512MGF1::engineGetURI() {
	$init($XMLSignature);
	return $XMLSignature::ALGO_ID_SIGNATURE_RSA_SHA512_MGF1;
}

SignatureBaseRSA$SignatureRSASHA512MGF1::SignatureBaseRSA$SignatureRSASHA512MGF1() {
}
...
$Class* SignatureBaseRSA$SignatureRSASHA512MGF1::class$ = nullptr;
