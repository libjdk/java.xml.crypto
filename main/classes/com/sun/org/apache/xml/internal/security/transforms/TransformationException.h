#ifndef _com_sun_org_apache_xml_internal_security_transforms_TransformationException_h_
#define _com_sun_org_apache_xml_internal_security_transforms_TransformationException_h_
//$ class com.sun.org.apache.xml.internal.security.transforms.TransformationException
...
class TransformationException : public ::com::sun::org::apache::xml::internal::security::exceptions::XMLSecurityException {
	$class(TransformationException, $NO_CLASS_INIT, ::com::sun::org::apache::xml::internal::security::exceptions::XMLSecurityException)
public:
	...
	TransformationException wrapper$();
...
#endif // _com_sun_org_apache_xml_internal_security_transforms_TransformationException_h_