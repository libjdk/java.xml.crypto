...
$MethodInfo _SignatureBaseRSA$SignatureRSASHA1MGF1_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(SignatureBaseRSA$SignatureRSASHA1MGF1::*)()>(&SignatureBaseRSA$SignatureRSASHA1MGF1::init$)), "com.sun.org.apache.xml.internal.security.signature.XMLSignatureException"},
	{"<init>", "(Ljava/security/Provider;)V", nullptr, $PUBLIC, $method(static_cast<void(SignatureBaseRSA$SignatureRSASHA1MGF1::*)($Provider*)>(&SignatureBaseRSA$SignatureRSASHA1MGF1::init$)), "com.sun.org.apache.xml.internal.security.signature.XMLSignatureException"},
	{"engineGetURI", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{}
};

$InnerClassInfo _SignatureBaseRSA$SignatureRSASHA1MGF1_InnerClassesInfo_[] = {
...
$ClassInfo _SignatureBaseRSA$SignatureRSASHA1MGF1_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	...
	nullptr,
	nullptr,
	_SignatureBaseRSA$SignatureRSASHA1MGF1_MethodInfo_,
	nullptr,
	nullptr,
	_SignatureBaseRSA$SignatureRSASHA1MGF1_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"com.sun.org.apache.xml.internal.security.algorithms.implementations.SignatureBaseRSA"
...
$Object* allocate$SignatureBaseRSA$SignatureRSASHA1MGF1($Class* clazz) {
	return $of($alloc(SignatureBaseRSA$SignatureRSASHA1MGF1));
}
...
$Class* SignatureBaseRSA$SignatureRSASHA1MGF1::load$($String* name, bool initialize) {
	$loadClass(SignatureBaseRSA$SignatureRSASHA1MGF1, name, initialize, &_SignatureBaseRSA$SignatureRSASHA1MGF1_ClassInfo_, allocate$SignatureBaseRSA$SignatureRSASHA1MGF1);
	return class$;
}
