...
$InnerClassInfo _SignatureBaseRSA$SignatureRSASHA224MGF1_InnerClassesInfo_[] = {
...
$ClassInfo _SignatureBaseRSA$SignatureRSASHA224MGF1_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	...
	nullptr,
	nullptr,
	_SignatureBaseRSA$SignatureRSASHA224MGF1_MethodInfo_,
	nullptr,
	nullptr,
	_SignatureBaseRSA$SignatureRSASHA224MGF1_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"com.sun.org.apache.xml.internal.security.algorithms.implementations.SignatureBaseRSA"
...
$Object* allocate$SignatureBaseRSA$SignatureRSASHA224MGF1($Class* clazz) {
	return $of($alloc(SignatureBaseRSA$SignatureRSASHA224MGF1));
}

void SignatureBaseRSA$SignatureRSASHA224MGF1::init$() {
	$SignatureBaseRSA::init$();
}

void SignatureBaseRSA$SignatureRSASHA224MGF1::init$($Provider* provider) {
	$SignatureBaseRSA::init$(provider);
}

$String* SignatureBaseRSA$SignatureRSASHA224MGF1::engineGetURI() {
	$init($XMLSignature);
	return $XMLSignature::ALGO_ID_SIGNATURE_RSA_SHA224_MGF1;
}

SignatureBaseRSA$SignatureRSASHA224MGF1::SignatureBaseRSA$SignatureRSASHA224MGF1() {
}

$Class* SignatureBaseRSA$SignatureRSASHA224MGF1::load$($String* name, bool initialize) {
	$loadClass(SignatureBaseRSA$SignatureRSASHA224MGF1, name, initialize, &_SignatureBaseRSA$SignatureRSASHA224MGF1_ClassInfo_, allocate$SignatureBaseRSA$SignatureRSASHA224MGF1);
	return class$;
}

$Class* SignatureBaseRSA$SignatureRSASHA224MGF1::class$ = nullptr;
